defmodule Day3.RucksackReorganizationTest do
  use ExUnit.Case

  describe "prioritize_rearrangement/1" do
...
CrZsJsPPZsGzwwsLwLmpwMDw"
      ...
      assert result == Day3.RucksackReorganization.prioritize_rearrangement(input)
    end
